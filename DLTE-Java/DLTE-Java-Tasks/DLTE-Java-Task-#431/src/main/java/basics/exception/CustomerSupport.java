    ...
    public static void main(String[] args) {
        ...
        switch(choice){
            case 1:try{
                ...
                customerSupport.creditCardLimit(creditCard);}catch (MyBankCreditCardException e){
                logger.log(Level.WARNING,resourceBundle.getString("limit.exception"));
                throw new MyBankCreditCardException("Limit exceeded");
            }
            break;
            case 2:try{customerSupport.creditCardBillPayment(creditCard,new Date(2023,03,11),new Date(2024,03,30));}catch(MyBankCreditCardException e){
                logger.log(Level.WARNING,resourceBundle.getString(""));
                throw new MyBankCreditCardException("Bill payment couldn't able to find");
            }
            break;
        }
