...
public class App {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        Customer customer5=new Customer("rakesh", "rak123", "Mangalore", "rak@gmail", 987455335L, 1000L, transactionOne);
        userInfoServices.callAddInformation(customer5);
...
//             userInfoServices.callUpdate("prash02",12345L);
            Customer customer = userInfoServices.callFindusername("prash02");
