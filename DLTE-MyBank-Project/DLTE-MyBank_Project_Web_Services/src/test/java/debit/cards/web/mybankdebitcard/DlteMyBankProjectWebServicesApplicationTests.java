...
//
//        when(debitCardRepository.getDebitCard()).thenReturn(debitCardList);
...
//        when(debitCardRepository.getDebitCard()).thenThrow(DebitCardException.class);
//
//        // Execute the method under test
//        ViewDebitCardResponse response = debitCardPhase.viewDebitCardResponse(viewDebitCardRequest);
//
...
//
//        // Mock the behavior of the debitCardRepository.getDebitCard() method to throw DebitCardException
//        when(debitCardRepository.getDebitCard()).thenThrow(DebitCardNullException.class);
//
//        // Execute the method under test
//        ViewDebitCardResponse response = debitCardPhase.viewDebitCardResponse(viewDebitCardRequest);
//
