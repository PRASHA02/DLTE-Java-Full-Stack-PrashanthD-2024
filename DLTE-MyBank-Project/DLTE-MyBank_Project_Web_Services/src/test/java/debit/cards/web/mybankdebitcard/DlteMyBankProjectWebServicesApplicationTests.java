...
class DlteMyBankProjectWebServicesApplicationTests {
    ...
    public void FetchAllDebitCard() throws SQLException {
        ...
        when(debitCardServices.getDebitCard()).thenReturn(debitCardList);
    ...
    public void FetchAllDebitCard_DebitCardException() throws SQLException {
        ...
        when(debitCardServices.getDebitCard()).thenThrow(DebitCardException.class);
    ...
    public void FetchAllDebitCard_DebitCardNullException() throws SQLException {
        ...
        // Mock the behavior of the debitCardServices.getDebitCard() method to throw DebitCardException
        when(debitCardServices.getDebitCard()).thenThrow(DebitCardNullException.class);
